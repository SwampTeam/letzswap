 ...
 */
final class Version20190416102629 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE picture (id INT AUTO_INCREMENT NOT NULL, item_id INT NOT NULL, mime_type VARCHAR(50) NOT NULL, path VARCHAR(255) NOT NULL, INDEX IDX_16DB4F89126F525E (item_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
