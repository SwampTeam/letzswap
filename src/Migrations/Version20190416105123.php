 ...
 */
final class Version20190416105123 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE item (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', user_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, condition_status VARCHAR(255) NOT NULL, INDEX IDX_1F1B251EA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE item_status (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', items_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', statuses_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', time DATETIME NOT NULL, INDEX IDX_FDF910D36BB0AE84 (items_id), INDEX IDX_FDF910D31259C1FF (statuses_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE picture (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', item_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', mime_type VARCHAR(50) NOT NULL, path VARCHAR(255) NOT NULL, INDEX IDX_16DB4F89126F525E (item_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE status (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', label VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_status (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', users_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', statuses_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', time DATETIME NOT NULL, INDEX IDX_1E527E2167B3B43D (users_id), INDEX IDX_1E527E211259C1FF (statuses_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
